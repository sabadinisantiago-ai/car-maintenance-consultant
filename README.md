...
Lógica de Mantenimiento Específica:

Frenos: Diferencia el desgaste entre cajas manuales y automáticas.

Distribución: Alerta por kilometraje o antigüedad (regla de los 5 años).

Bujías: Ajuste de intervalos según el uso de GNC o nafta pura.

Combustible: Diferenciación de costos y límites entre motores Diesel y Nafta.
...
Entorno: Desarrollado y testeado en macOS (MacBook Air M1).

Conceptos aplicados: Diccionarios anidados, listas, bucles while, lógica condicional compleja y formateo de datos.
